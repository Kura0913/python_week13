...
class MenuWidget(QtWidgets.QWidget):
    def __init__(self, update_widget_callback):
        ...
        self.add_button.clicked.connect(lambda: self.click_button("add"))
        self.show_button.clicked.connect(lambda: self.click_button("show"))
...
class FunctionWidget(QtWidgets.QStackedWidget):
    ...
    def update_widget(self, name):
        ...
        current_widget.load(self.socket_client)
